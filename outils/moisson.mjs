...
const SPECS = {
  ...
  hemo: {
    ...
    termes: ['fluid resuscitation', 'balanced crystalloid', 'albumin critically ill',
             'vasopressor', 'norepinephrine', 'cardiogenic shock', 'transfusion threshold',
             'tranexamic acid', 'coagulopathy', 'hemodynamic monitoring', 'cardiac output monitoring',
             'mechanical circulatory support', 'acute kidney injury renal replacement'],
  },
  neurotrauma: {
    nom: 'Neuroréanimation & traumatologie',
    termes: ['traumatic brain injury', 'intracranial pressure', 'subarachnoid hemorrhage',
             'intracerebral hemorrhage critical care', 'status epilepticus', 'polytrauma',
             'major trauma', 'massive transfusion', 'damage control resuscitation',
             'spinal cord injury', 'neuroprognostication', 'decompressive craniectomy'],
  },
  obst: {
    nom: 'Anesthésie obstétricale',
    termes: ['obstetric anesthesia', 'cesarean delivery anesthesia', 'labor epidural analgesia',
             'postpartum hemorrhage', 'preeclampsia critical care', 'maternal critical care',
             'spinal hypotension cesarean', 'amniotic fluid embolism'],
  },
  ped: {
    nom: 'Anesthésie-réanimation pédiatrique',
    termes: ['pediatric anesthesia', 'pediatric intensive care', 'neonatal intensive care ventilation',
             'pediatric sepsis', 'pediatric airway management', 'pediatric sedation',
             'congenital heart surgery anesthesia', 'bronchiolitis respiratory support'],
  },
  arret: {
