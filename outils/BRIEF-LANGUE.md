# Brief — relecture de langue (Pause AR)
...
Tu es **anesthésiste-réanimateur francophone**. Tu lis cette fiche entre deux interventions, sur ton
téléphone, avec le bruit du bloc autour. Tu n'as ni le temps ni l'envie de relire une phrase deux fois.
...
4. **Les abréviations non développées** quand elles ne sont pas celles que tout anesthésiste-réanimateur
   lit d'un coup d'œil (SDRA, PEP, ALR, AG, ECMO restent telles quelles ; le reste se développe à la
   première occurrence).
