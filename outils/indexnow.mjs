#!/usr/bin/env node
/* -----------------------------------------------------------------------------
 * Pause AR — prévenir les moteurs dès la publication (protocole IndexNow).
 *
 ...
 * l'adresse `https://pausear.fr/<clé>.txt` : c'est ainsi que le moteur vérifie
