# Brief — révision d'une carte existante (Pause AR)
...
Tu es rédacteur médical francophone spécialisé en anesthésie-réanimation. Tu reçois des cartes existantes du site
